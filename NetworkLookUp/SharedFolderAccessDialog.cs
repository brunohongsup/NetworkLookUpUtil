...
{
    public partial class SharedFolderAccessDialog : Form
    {
        public SharedFolderAccessDialog()
        {
            InitializeComponent();
            PopulateComboBoxWithComputersInNetwork();
        }
      ...
      SuppressUnmanagedCodeSecurityAttribute]
        ...
        private void PopulateComboBoxWithComputersInNetwork()
        {
            var computers = GetNetworkComputerNames();
            foreach (var computer in computers)
            {
                comboBoxCompsInNetwork.Items.Add(computer); 
            }
        }
